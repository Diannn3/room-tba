...
flowchart TB
  ...
  root --> public["static/ static assets"]
  root --> agents[AGENTS.md]
  src --> routes["routes/ routes + /api"]
  src --> lib["lib/ stores, services, PGlite sync, constants"]
...
| Eunice Almeyda | Logo |
| Mary Gwyneth Telmosa | Verification of initial room positions |
