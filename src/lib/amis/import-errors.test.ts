...
import { classesScheduleFreshnessMessage, isClassesScheduleStale } from './term-schedule-freshness';
...
describe('term-schedule-freshness', () => {
	...
	it('shows fresh message for recent import', () => {
		...
		expect(classesScheduleFreshnessMessage(recent)).toContain('Schedules updated');
	});
});
