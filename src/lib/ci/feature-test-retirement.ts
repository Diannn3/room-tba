 ...
 * follow suit.
 */
export function featureTestRetirementFailures(changedFiles: ChangedFile[]): string[] {
	...
	const inventoryChanged = changedFiles.some((file) => file.path === 'docs/test-inventory.md');
