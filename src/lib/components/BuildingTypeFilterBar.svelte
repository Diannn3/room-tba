...
<div class="building-filter-bar" role="toolbar" aria-label="Building pin filters">
	...
	<div class="filter-chips">
		{#each options as option (option.value)}
			{@const isActive = pinFilterContext && buildingTypeFilter.value === option.value}
			...
			>
				<span class="map-chrome-chip__icon map-chrome-chip__icon--{option.tone}" aria-hidden="true">
					<Icon size={14} />
				</span>
