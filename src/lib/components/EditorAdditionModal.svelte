<script lang="ts">
	...
	import { adminAuthStore, editorChromeStore } from '$lib/stores.svelte';
...
<svelte:window onkeydown={handleKeydown} onpointerdown={handleDocumentPointerDown} />

{#if editorChromeStore.additionModalOpen}
	<div class="editor-addition-overlay" transition:fade={overlayFade(reducedMotion.current)}>
		<div
			bind:this={dialogEl}
