...
<div class="entity-detail class-query-container">
	...
	<div class="results-list">
		{#if !courseQuery}
			<div class="no-results">
				<p>Enter a course code (e.g. CMSC 130) to look up sections and rooms.</p>
				<button type="button" class="entity-footer__link" onclick={openBrowseAll}>
					Browse all classes →
				</button>
			</div>
	...
	{#if courseQuery && looksLikeCourseCode(courseQuery)}
		<section class="entity-list-section finals-section" aria-label="Final exams">
