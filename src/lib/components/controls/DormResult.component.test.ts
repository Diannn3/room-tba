...
describe('DormResult Kubo link', () => {
	...
	test('renders a safe Kubo CTA for an API-confirmed dorm without mobile overflow', () => {
		...
		expect(link).toHaveAttribute('href', 'https://kubo.community/dorms/arable-premier-residences');
		...
		const links = container.querySelector<HTMLElement>('.entity-dorm-details__links');
