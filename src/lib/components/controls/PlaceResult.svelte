	...
	<div class="entity-detail">
		<header class="entity-header">
			...
			{#if placeDirectoryLabel(place.category)}
				<span class="place-category-badge">{placeDirectoryLabel(place.category)}</span>
			{/if}
			<div class="entity-actions">
				{#if place.lat != null && place.lon != null}
					<EntityDirectionsChip lat={place.lat} lon={place.lon} destinationLabel={place.name} />
		...
		{:else}
			<div class="place-form">
				...
				<label>Description<textarea bind:value={descriptionDraft} rows="2"></textarea></label>
				...
				<div class="place-form__actions">
					<button type="button" class="place-edit-btn" disabled={submitting} onclick={submit}>
