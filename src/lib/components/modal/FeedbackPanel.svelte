...
<div class="feedback-panel">
	...
	{:else}
		<form class="entity-editor-form feedback-panel__form" onsubmit={submit}>
			...
			<p class="feedback-panel__attached">
				Sent with your message: the screen you are on ({screen ?? 'unknown'}), app version {APP_VERSION_LABEL},
				and whether you were {wasOnline === false ? 'offline' : 'online'}. No email and no IP
				address are stored.
			</p>
	...
	<p class="feedback-panel__talk">
		...
		<CommunityPlatformLink brand="messenger" href={MESSENGER_CONTRIBUTE_URL} label="Messenger" />
