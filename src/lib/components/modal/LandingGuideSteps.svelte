...
<section class="guide" aria-labelledby="guide-heading">
	...
	<ul class="feature-grid">
		{#each features as feature (feature.label)}
			<li class="feature-card" class:feature-card--secondary={feature.secondary}>
	...
	<p class="guide-footnote">
		Questions or want to volunteer? Use <strong>Suggest an edit</strong> on the map, or reach us on
