	...
	<header class="landing-header">
		<div class="hero-image">
			<div class="hero-overlay" class:collapse-hero={activeTab === 'campus'}>
				...
				<p class="hero-tagline">Find rooms, explore the map, and discover campus events at UPLB.</p>
			</div>
		</div>
		...
		{:else}
			...
			>
				...
				<section class="community-block">
					...
					<p class="section-note">
						Suggest fixes in the map, or chat on Discord or Messenger if you want to help verify
						data.
					</p>
					<ul class="community-links">
						<li>
							<a href={UPLB_TOOLS_URL} target="_blank" rel="noopener noreferrer" class="inline-link"
								>UPLB Tools</a
							>
						</li>
						<li>
