	...
	<div class="modal-set">
		...
		>
			...
			{:else if modalStore.type === 'schedule-expand'}
				<IconButton class="modal-content__close-icon" label="Close schedule" onclick={closeDialog}>
			...
			{:else if modalStore.type === 'changelog'}
				<IconButton class="modal-content__close-icon" label="Close changelog" onclick={closeDialog}>
					<X size={20} aria-hidden="true" />
				</IconButton>
				<ChangelogModal />
			...
			{:else if modalStore.type === 'review'}
				<IconButton class="modal-content__close-icon" label="Close review" onclick={closeDialog}>
					<X size={20} aria-hidden="true" />
				</IconButton>
			...
			{:else if modalStore.type === 'settings'}
				<IconButton class="modal-content__close-icon" label="Close settings" onclick={closeDialog}>
					<X size={20} aria-hidden="true" />
				</IconButton>
				<SettingsModal />
