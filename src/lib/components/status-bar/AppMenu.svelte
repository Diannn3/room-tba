			...
			{#if !contributorSession}
				<section class="app-menu__section" aria-label="Account">
					<button type="button" class="app-menu__action map-chrome-chip" onclick={handleSignIn}>
						...
						<span>
							{adminAuthStore.username ? 'Account settings' : 'Contributor sign in'}
						</span>
					</button>
				</section>
			{/if}
           ...
           map chrome, so they live here rather than in the primary nav. -->
			...
			{#if adminAuthStore.canReview}
				<section class="app-menu__section" aria-label="Review">
					<button type="button" class="app-menu__action map-chrome-chip" onclick={handleReview}>
			...
			<section class="app-menu__section" aria-labelledby="app-menu-data-heading">
				...
				<button type="button" class="app-menu__action map-chrome-chip" onclick={handleCoverage}>
			...
			<section class="app-menu__section" aria-labelledby="app-menu-links-heading">
			...
			<section class="app-menu__section" aria-labelledby="app-menu-help-heading">
				<h3 id="app-menu-help-heading" class="app-menu__heading">Help</h3>
				<a class="app-menu__action map-chrome-chip" href="/faq" onclick={closePanel}>
					<CircleHelp size={14} aria-hidden="true" />
					<span>Help &amp; FAQ</span>
				</a>
				<button type="button" class="app-menu__action map-chrome-chip" onclick={handleHowItWorks}>
					<LifeBuoy size={14} aria-hidden="true" />
					<span>How Room TBA works</span>
				</button>
				<button type="button" class="app-menu__action map-chrome-chip" onclick={handleWhatsNew}>
			...
			<section class="app-menu__section app-menu__section--install" aria-label="Install app">
				<PWAInstallPrompt />
			</section>
		</div>
	{/if}
