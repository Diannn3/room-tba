...
import { campusCommunity, campusSite } from '$lib/utils/campus.config';
...
export const MESSENGER_CONTRIBUTE_TARGET = campusCommunity.messengerContributeTarget;
export const MESSENGER_MAINTAIN_TARGET = campusCommunity.messengerMaintainTarget;

/** Short links on a community subdomain (Cloudflare Worker). */
export const MESSENGER_SHORT_CONTRIBUTE_URL = campusCommunity.messengerShortContributeUrl;
export const MESSENGER_SHORT_MAINTAIN_URL = campusCommunity.messengerShortMaintainUrl;
