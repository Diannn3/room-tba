...
import { campusMap, campusTerrain } from '$lib/campus.config';
...
export const CAMPUS_MAX_BOUNDS: [[number, number], [number, number]] = campusMap.maxBounds;
...
export const TERRAIN_MAX_BOUNDS: [[number, number], [number, number]] = campusTerrain.maxBounds;
