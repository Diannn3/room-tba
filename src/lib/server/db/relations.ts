...
export const eventLocationsRelations = relations(eventLocationsTable, ({ one, many }) => ({
...
export const eventRoutesRelations = relations(eventRoutesTable, ({ one, many }) => ({
	event: one(eventsTable, {
...
export const eventRouteStopsRelations = relations(eventRouteStopsTable, ({ one }) => ({
