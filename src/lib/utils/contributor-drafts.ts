...
import type { EventPlacementDraft } from '$lib/utils/store.svelte';
...
export type SuggestAdditionDraft = {
	...
	dormGender: string;
	placeName?: string;
	placeCategory?: 'food' | 'tourist-spot' | 'landmark' | 'service' | 'transport';
...
export function readSuggestAdditionDraft(): SuggestAdditionDraft | null {
	return readEnvelope<SuggestAdditionDraft>(CONTRIBUTOR_DRAFT_KEYS.suggestAddition);
}
...
export function readEntityContributorDraft(
	...
	return readEnvelope<EntityContributorDraft>(CONTRIBUTOR_DRAFT_KEYS.entity(entityType, entityId));
}
...
export function clearEntityContributorDraft(entityType: string, entityId: number): void {
...
export function scheduleSuggestAdditionDraftSave(getData: () => SuggestAdditionDraft): void {
	scheduleContributorDraftSave(
...
export function scheduleProposeEventDraftSave(getData: () => ProposeEventDraft): void {
	scheduleContributorDraftSave(
