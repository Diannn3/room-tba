import { groupClassesByOffering, type ClassOfferingGroup } from '../class-offering-groups.js';
...
export function alternativeOfferings(
	...
	return groupClassesByOffering(rows).filter(
		(o) =>
			!o.key.startsWith('__solo__') && o.courseCode === courseCode && o.section !== currentSection
	);
}
