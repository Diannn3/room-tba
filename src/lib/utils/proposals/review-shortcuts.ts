import { isTypingTarget } from '$lib/utils/keyboard-shortcuts';
...
export type ReviewShortcutAction = 'approve' | 'reject' | 'next' | 'previous' | 'undo';
...
export function stepIndex(current: number | null, total: number, direction: 1 | -1): number | null {
