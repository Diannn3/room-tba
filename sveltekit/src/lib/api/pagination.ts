...
export type PaginationParamResult = { ok: true; value: number } | { ok: false; error: string };
...
export function clampLimitParam(raw: string | null, options: LimitOptions): PaginationParamResult {
