...
<div class="terrain-control" class:embedded>
	{#if showPanel}
		<div class="terrain-panel" class:embedded>
			...
			<div class="map-chrome-row">
				<span class="map-chrome-row__label" id="terrain-exaggeration-label"> Exaggeration </span>
				<div
				...
				>
					{#each TERRAIN_EXAGGERATION_OPTIONS as option (option)}
						<button
							type="button"
							class="map-chrome-chip"
							class:map-chrome-chip--toggle-active={terrainStore.exaggeration === option}
			...
			<p class="map-chrome-row-note">
				Elevation tiles by <a href="https://www.maptiler.com/" target="_blank" rel="noreferrer"
					>MapTiler</a
				>.
			</p>
		</div>
