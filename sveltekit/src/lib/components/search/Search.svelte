...
<style>
	...
	.search-root.mobile-shell {
       ...
       map/nav stay clickable; active fades white in (no layout jump). */
		...
		pointer-events: none;
		transition: background-color var(--motion-duration-micro, 200ms) var(--motion-ease-out, ease);
	}
	...
	.search-root.mobile-shell .search-shell-main {
		...
		margin: 0;
		padding: var(--staging-banner-gap, 0.5rem) max(1rem, env(safe-area-inset-right, 0px)) 0.5rem
		...
		box-shadow: none;
		pointer-events: auto;
		transition: padding var(--motion-duration-micro, 200ms) var(--motion-ease-out, ease);
	}
	...
	.search-root.mobile-shell .map-search-chrome--mobile-redesign {
		...
		background: transparent;
		box-shadow: none;
		transition: gap var(--motion-duration-micro, 200ms) var(--motion-ease-out, ease);
	}

	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__bar {
		padding: 0;
	}

	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__bar-row {
		align-items: center;
		min-width: 0;
		gap: 0;
		transition: gap var(--motion-duration-micro, 200ms) var(--motion-ease-out, ease);
	...
	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__pill-wrap {
		width: 100%;
		min-width: 0;
	}

	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__pill {
		box-sizing: border-box;
		width: 100%;
		min-height: 3rem;
		gap: 0.6rem;
	...
	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__pill input {
		font-size: 0.875rem;
		font-weight: 500;
		color: #111;
	...
	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__mobile-chips {
		min-width: 0;
		width: 100%;
		padding-right: 0.125rem;
	}

	.search-root.mobile-shell .map-search-chrome--mobile-redesign :global(.map-filter-chips) {
		height: auto;
	}

	.search-root.mobile-shell .map-search-chrome--mobile-redesign :global(.map-filter-chips__chip) {
	...
	.search-root.mobile-shell .map-search-chrome--mobile-redesign :global(.map-filter-chips__more) {
	...
	.search-root.mobile-shell .map-search-chrome--mobile-redesign .map-search-chrome__suggestions {
		width: 100%;
		flex: 1 1 auto;
		min-height: 0;
		margin: 0;
	...
	.search-root.mobile-shell.search-mobile-active .map-search-chrome--mobile-redesign {
		flex: 1 1 auto;
		gap: 0.75rem;
	}

	.search-root.mobile-shell.search-mobile-active .map-search-chrome__bar-row {
		gap: 0;
	}
	...
	.search-root.mobile-shell.search-mobile-active .map-search-chrome__pill input {
		min-width: 0;
		font-size: 0.9375rem;
	}
	...
	.search-root.search-suggestions-open:not(.mobile-shell):not(.events-panel-open):not(
			.transit-panel-open
		)
		.map-search-chrome__suggestions {
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__bar {
		padding: 0;
	}

	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__bar-row {
		align-items: center;
		gap: var(--map-filter-gap, 0.375rem);
		flex-wrap: nowrap;
	}

	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__pill-wrap {
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__add {
		display: inline-flex;
		flex: 0 0 auto;
		align-items: center;
		gap: 0.3rem;
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__add:hover {
		background: #fcdada;
	}

	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__pill {
		box-sizing: border-box;
		width: 100%;
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__pill input {
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign .map-search-chrome__suggestions {
		width: var(--map-search-width, 26rem);
		max-width: 100%;
		margin-top: 0.5rem;
		border: none;
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign :global(.map-filter-chips) {
		flex: 1 1 auto;
		width: auto;
		max-width: none;
		min-width: 0;
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign :global(.map-filter-chips__chip) {
	...
	.search-root:not(.mobile-shell) .map-search-chrome--redesign :global(.map-filter-chips__more) {
