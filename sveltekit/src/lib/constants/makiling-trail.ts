...
export const MAKILING_TRAIL_STATIONS: TrailStation[] = [
	...
	},
	{
		...
		description: 'Side trip to Mud Spring — sulfuric fumes and boiling mud. Geothermal feature.',
		elevationMeters: 280,
		lon: 121.2308,
		lat: 14.1438
	},
	...
	},
	{
		...
		description: 'Main campsite. Wilderness zone begins here — leeches (limatik) common.',
		elevationMeters: 620,
		lon: 121.2285,
		lat: 14.1375
	},
	...
	},
	{
		...
		description: 'Trail forks — left to Peak 1, right continues to Peak 2 (summit).',
...
export const MAKILING_TRAIL_LINE: [number, number][] = MAKILING_TRAIL_STATIONS.map((s) => [
	s.lon,
	s.lat
]);
