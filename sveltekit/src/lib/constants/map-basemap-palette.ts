...
export const BASEMAP_RECESS_LAYER_IDS = ['poi_z14', 'poi_z15', 'poi_z16', 'poi_transit'] as const;
...
export function buildingSizeColorExpression(
	palette: Pick<typeof uplbRefreshing, 'buildingFill' | 'buildingExtrusion'> = MAP_BASEMAP_PALETTE
...
export const BASEMAP_LAYER_PAINT: Record<string, Record<string, BasemapPaintValue>> = {
	background: {
