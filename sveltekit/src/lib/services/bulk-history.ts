...
export function toHistoryRow(op: BulkOperation, actor: string = BULK_ACTOR): BulkHistoryRow {
	assert(
...
export function pendingRows(rows: BulkHistoryRow[], seen: Iterable<SeenRow>): BulkHistoryRow[] {
