...
export async function refreshSupabaseSession(event: RequestEvent): Promise<void> {
...
export function applySupabaseCacheHeaders(response: Response, event: RequestEvent): Response {
