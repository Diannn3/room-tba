...
import { parseTermIdFromSearch, TERM_QUERY_PARAM, withTermQuery } from './term-url';
...
describe('term-url', () => {
	...
	it('appends term query when not default', () => {
		expect(withTermQuery('/map/rooms/ics-260-12/', 1251, 1252)).toBe(
			'/map/rooms/ics-260-12/?term=1251'
		);
		expect(withTermQuery('/map/rooms/ics-260-12/', 1252, 1252)).toBe('/map/rooms/ics-260-12/');
	});
