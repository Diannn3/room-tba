		...
		const organization = await createOrganization(
			{
				...
				roomId: body.roomId === null || body.roomId === undefined ? null : Number(body.roomId),
				description: typeof body.description === 'string' ? body.description.trim() : null,
				websiteLink: typeof body.websiteLink === 'string' ? body.websiteLink.trim() : null,
				facebookLink: typeof body.facebookLink === 'string' ? body.facebookLink.trim() : null,
